const covid19ImpactEstimator = (data) => {
  ...
  output.impact.dollarsInFlight = Math.floor(
    output.impact.severeCasesByRequestedTime * data.region.avgDailyIncomePopulation * data.region.avgDailyIncomeInUSD * data.timeToElapse
  );
  output.severeImpact.dollarsInFlight = Math.floor(
    output.severeImpact.severeCasesByRequestedTime * data.region.avgDailyIncomePopulation * data.region.avgDailyIncomeInUSD * data.timeToElapse
  );
